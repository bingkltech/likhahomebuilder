...
// Static data hoisted outside the component to ensure stable references and prevent
...
const ImageCarousel = React.memo(({ images }) => {
  ...
  // ⚡ Bolt Performance Optimization:
  // Using refs for high-frequency UI updates (mouse tilt, drag offset)
  // and manipulating CSS variables directly to avoid React re-renders.
  ...
  const handleMove = (clientX) => {
    ...
    // Direct DOM manipulation to bypass React render loop
